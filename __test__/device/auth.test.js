...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Clarabelle_King76',
      password: 'x_ClzpFRIbOsUdi',
      email: 'Brandt_Wuckert2@hotmail.com',
      name: 'Pete Gerlach',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 237,
      mobileNo: '(015) 103-4246',
      resetPasswordLink: {},
      loginRetryLimit: 929,
      loginReactiveTime: '2023-11-19T02:04:51.891Z',
      id: '643b6b1eb8916e93a91da9f1'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Melvin.King',
        'password':'8OHQ1bB4zKkMfUV',
        'email':'Briana.Osinski@gmail.com',
        'name':'Helen O\'Keefe MD',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Bedfordshire',
          'address1':'Markets',
          'address2':'collaboration',
          'landmark':'Oregon',
          'city':'matrix',
          'isDefault':true,
          'state':'capacitor',
          'addressType':'Keyboard',
          'fullName':'Garden',
          'mobile':268,
          'addressNo':485
        }],
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Briana.Osinski@gmail.com', });
